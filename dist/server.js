...
const { Readable, Writable } = __webpack_require__(2203);
...
__webpack_unused_export__ = IncomingMessage;
__webpack_unused_export__ = ServerResponse;
module.exports.is = setHttpCallback;
...
var rawAsap = __webpack_require__(7342);
var freeTasks = [];
...
const mimeTypes = __webpack_require__(6049);
const LRU = __webpack_require__(3393);
...
exports = module.exports = __webpack_require__(888);
exports.json = __webpack_require__(6458);
exports.form = __webpack_require__(6354);
exports.text = __webpack_require__(5507);
...
const typeis = __webpack_require__(1592);
const json = __webpack_require__(6458);
const form = __webpack_require__(6354);
const text = __webpack_require__(5507);
...
const raw = __webpack_require__(7680);
const inflate = __webpack_require__(4881);
const qs = __webpack_require__(5373);
const utils = __webpack_require__(4099);
...
var deprecate = __webpack_require__(6330)('cookies')
var Keygrip = __webpack_require__(2760)
...
var objectKeys = __webpack_require__(1264);
var isArguments = __webpack_require__(5491);
...
var asap = __webpack_require__(983)
...
var minimatch = __webpack_require__(4027)
var isAbsolute = __webpack_require__(2641)
...
var isAbsolute = __webpack_require__(2641)
var globSync = __webpack_require__(4700)
var common = __webpack_require__(1198)
var alphasort = common.alphasort
var alphasorti = common.alphasorti
var setopts = common.setopts
var ownProp = common.ownProp
var inflight = __webpack_require__(3423)
...
var minimatch = __webpack_require__(4027)
var Minimatch = minimatch.Minimatch
var Glob = (__webpack_require__(3577).Glob)
var util = __webpack_require__(9023)
var path = __webpack_require__(6928)
var assert = __webpack_require__(2613)
var isAbsolute = __webpack_require__(2641)
...
var eql = __webpack_require__(4982)
...
var deprecate = __webpack_require__(4628)('http-errors')
...
var callSiteToString = (__webpack_require__(251).callSiteToString)
var eventListenerCount = (__webpack_require__(251).eventListenerCount)
var relative = (__webpack_require__(6928).relative)
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(9861)
})

lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount () {
  return EventEmitter.listenerCount || __webpack_require__(5246)
})
...
var compare = __webpack_require__(4719)
...
const types_1 = __webpack_require__(6476);
const co_body_1 = __importDefault(__webpack_require__(9582));
const string_method_to_enum_method_1 = __importDefault(__webpack_require__(9922));
const throwable_to_error_1 = __importDefault(__webpack_require__(6870));
const body_type_util_1 = __webpack_require__(8949);
const parse_with_formidable_1 = __importDefault(__webpack_require__(869));
const patch_util_1 = __webpack_require__(1306);
__exportStar(__webpack_require__(6476), exports);
...
const zod_1 = __webpack_require__(1614);
var HttpMethodEnum;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const formidable_1 = __importDefault(__webpack_require__(1211));
...
const unparsed_1 = __importDefault(__webpack_require__(9375));
...
"use strict";
var __dirname = "node_modules\\koa-body\\node_modules\\formidable\\src";
...
const PersistentFile = __webpack_require__(7872);
const VolatileFile = __webpack_require__(3205);
const DummyParser = __webpack_require__(3396);
const MultipartParser = __webpack_require__(9004);
const errors = __webpack_require__(8820);
...
class IncomingForm extends EventEmitter {
  constructor(options = {}) {
    ...
    this.options.enabledPlugins.forEach((pluginName) => {
      ...
      this.use(__webpack_require__(6694)(path.join(__dirname, 'plugins', `${plgName}.js`)));
    });
...
const PersistentFile = __webpack_require__(7872);
const VolatileFile = __webpack_require__(3205);
const Formidable = __webpack_require__(5676);
const FormidableError = __webpack_require__(8820);

const plugins = __webpack_require__(2107);
const parsers = __webpack_require__(1220);
...
const { Transform } = __webpack_require__(2203);
const querystring = __webpack_require__(3480);
...
const JSONParser = __webpack_require__(8783);
const DummyParser = __webpack_require__(3396);
const MultipartParser = __webpack_require__(9004);
const OctetStreamParser = __webpack_require__(3283);
const QueryStringParser = __webpack_require__(3250);
...
const octetstream = __webpack_require__(8567);
const querystring = __webpack_require__(2825);
const multipart = __webpack_require__(5488);
const json = __webpack_require__(5600);
...
const co = __webpack_require__(2395)
const compose = __webpack_require__(8287)
...
const { parse: parseUrl, format: formatUrl } = __webpack_require__(7016);
const { pathToRegexp, compile, parse } = __webpack_require__(5867);
...
const compose = __webpack_require__(8287);
const HttpError = __webpack_require__(1972);
const methods = __webpack_require__(4761);
const { pathToRegexp } = __webpack_require__(5867);
const Layer = __webpack_require__(9233);
const debug = __webpack_require__(5753)('koa-router');
...
var setPrototypeOf = __webpack_require__(7270)
var statuses = __webpack_require__(7718)
var inherits = __webpack_require__(2017)
var toIdentifier = __webpack_require__(6963)
...
var codes = __webpack_require__(5527)
...
const isGeneratorFunction = __webpack_require__(8184);
const debug = __webpack_require__(5753)('koa:application');
const onFinished = __webpack_require__(5649);
const assert = __webpack_require__(2613);
const response = __webpack_require__(1631);
const compose = __webpack_require__(8287);
const context = __webpack_require__(2013);
const request = __webpack_require__(2043);
const statuses = __webpack_require__(2403);
const Emitter = __webpack_require__(4434);
const util = __webpack_require__(9023);
const Stream = __webpack_require__(2203);
const http = __webpack_require__(8611);
const only = __webpack_require__(9339);
const convert = __webpack_require__(8488);
const deprecate = __webpack_require__(6330)('koa');
const { HttpError } = __webpack_require__(2771);
...
module.exports = class Application extends Emitter {
  ...
  constructor(options) {
    ...
    if (options.asyncLocalStorage) {
      const { AsyncLocalStorage } = __webpack_require__(290);
...
const util = __webpack_require__(9023);
const createError = __webpack_require__(2771);
const httpAssert = __webpack_require__(1102);
const delegate = __webpack_require__(9807);
const statuses = __webpack_require__(2403);
const Cookies = __webpack_require__(9228);
...
const URL = (__webpack_require__(7016).URL);
const net = __webpack_require__(9278);
const accepts = __webpack_require__(2594);
const contentType = __webpack_require__(8597);
const stringify = (__webpack_require__(7016).format);
const parse = __webpack_require__(3189);
const qs = __webpack_require__(3480);
const typeis = __webpack_require__(1592);
const fresh = __webpack_require__(1427);
const only = __webpack_require__(9339);
const util = __webpack_require__(9023);
...
const contentDisposition = __webpack_require__(1164);
const getType = __webpack_require__(4256);
const onFinish = __webpack_require__(5649);
const escape = __webpack_require__(580);
const typeis = (__webpack_require__(1592).is);
const statuses = __webpack_require__(2403);
const destroy = __webpack_require__(7013);
const assert = __webpack_require__(2613);
const extname = (__webpack_require__(6928).extname);
const vary = __webpack_require__(677);
const only = __webpack_require__(9339);
const util = __webpack_require__(9023);
const encodeUrl = __webpack_require__(2224);
const Stream = __webpack_require__(2203);
...
var fs = __webpack_require__(9896);
var ncp = (__webpack_require__(1539).ncp);
var path = __webpack_require__(6928);
var rimraf = __webpack_require__(4239);
var mkdirp = __webpack_require__(1099);
...
var createError = __webpack_require__(6336)
...
var deprecate = __webpack_require__(6330)('http-errors')
var setPrototypeOf = __webpack_require__(7270)
var statuses = __webpack_require__(9650)
var inherits = __webpack_require__(2017)
var toIdentifier = __webpack_require__(6963)
...
var codes = __webpack_require__(6723)
...
var path = __webpack_require__(6928)
var fs = __webpack_require__(9896)
var glob = __webpack_require__(3577)
...
var rng = __webpack_require__(4551);
...
const util_1 = __webpack_require__(2146);
...
const en_1 = __importDefault(__webpack_require__(8227));
...
__exportStar(__webpack_require__(7231), exports);
__exportStar(__webpack_require__(1892), exports);
__exportStar(__webpack_require__(2146), exports);
__exportStar(__webpack_require__(2739), exports);
__exportStar(__webpack_require__(6837), exports);
...
const errors_1 = __webpack_require__(627);
const en_1 = __importDefault(__webpack_require__(8227));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.z = void 0;
const z = __importStar(__webpack_require__(6555));
exports.z = z;
__exportStar(__webpack_require__(6555), exports);
exports["default"] = z;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const util_1 = __webpack_require__(2146);
const ZodError_1 = __webpack_require__(6837);
...
const errors_1 = __webpack_require__(627);
const errorUtil_1 = __webpack_require__(9750);
const parseUtil_1 = __webpack_require__(7231);
const util_1 = __webpack_require__(2146);
const ZodError_1 = __webpack_require__(6837);
...
// EXTERNAL MODULE: ./node_modules/@citizenfx/http-wrapper/index.js
var http_wrapper = __webpack_require__(8814);
// EXTERNAL MODULE: ./node_modules/uuid/index.js
var uuid = __webpack_require__(8414);
// EXTERNAL MODULE: external "fs"
var external_fs_ = __webpack_require__(9896);
// EXTERNAL MODULE: ./node_modules/koa/lib/application.js
var application = __webpack_require__(5856);
;// CONCATENATED MODULE: ./node_modules/koa/dist/koa.mjs


/* harmony default export */ const koa = (application);
const HttpError = application.HttpError;

// EXTERNAL MODULE: ./node_modules/koa-router/lib/router.js
var router = __webpack_require__(5427);
// EXTERNAL MODULE: ./node_modules/koa-body/lib/index.js
var lib = __webpack_require__(6069);
// EXTERNAL MODULE: ./node_modules/mv/index.js
var mv = __webpack_require__(846);
...
const app = new koa();
const server_router = new router();
class UploadData {
}
const uploads = {};
server_router.post('/upload/:token', (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (uploads[tkn] !== undefined) {
        ...
        if (f) {
            if (upload.fileName) {
                ...
                external_fs_.readFile(f.filepath, (err, data) => {
                    if (err) {
                        finish(err.message, null);
                        return;
                    }
                    external_fs_.unlink(f.filepath, (err) => {
...
app
    ...
    .use(server_router.routes())
    .use(server_router.allowedMethods());
(0,http_wrapper/* setHttpCallback */.is)(app.callback());
// Cfx stuff
